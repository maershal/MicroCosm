...
void World::InitPopulation() {
    ...
    for(int i=0; i<80; i++) agents.emplace_back(Vector2{RandomFloat(50, Config::SCREEN_W-50), RandomFloat(50, Config::SCREEN_H-50)});
...
void World::Update(float dt) {
    ...
    if (agents.empty()) InitPopulation();
